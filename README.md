...
Repo auf GitHub: [`schroepa/comunio-skrt`](https://github.com/schroepa/comunio-skrt). Heute noch ohne Login; geplant: Invite-only für die Comunio-Gruppe (`docs/spec-auth.md`).
...
| `SquadMembership` | eigener Kader, Kaufpreis (pro User ab V1.25) | **immer manuell** |
| `UserProfile` | Anzeigename, Budget | manuell / Login (V1.25) |
| `CompetitorSquad` | 2–3 Liga-Rivalen (pro User) | manuell, später |
...
**V1.25** Gruppen-Login (Invite-only) — [`docs/spec-auth.md`](docs/spec-auth.md). **V1.5** Konkurrenz-Vergleich (leicht). **V2** Aufstellung, Punkteprognose, voller Konkurrenz-Vergleich.
